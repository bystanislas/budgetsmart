...
export const DEVISES: [string, string, string, number, number][] = [
  ...
  // Devises des autres pays proposés dans les paramètres. Le taux est laissé
  // à zéro : il signifie « cours non renseigné », et non « un pour un ». Une
  // conversion qui en dépend est signalée à l'utilisateur au lieu d'être
  // calculée en silence sur une valeur inventée.
  ['AOA', 'Kwanza angolais', 'Kz', 0, 2],
  ['BWP', 'Pula botswanais', 'P', 0, 2],
  ['BIF', 'Franc burundais', 'FBu', 0, 0],
  ['CVE', 'Escudo cap-verdien', 'CVE', 0, 2],
  ['KMF', 'Franc comorien', 'CF', 0, 0],
  ['DJF', 'Franc djiboutien', 'Fdj', 0, 0],
  ['ERN', 'Nakfa érythréen', 'Nfk', 0, 2],
  ['SZL', 'Lilangeni d’Eswatini', 'E', 0, 2],
  ['ETB', 'Birr éthiopien', 'Br', 0, 2],
  ['GMD', 'Dalasi gambien', 'D', 0, 2],
  ['LSL', 'Loti lesothan', 'L', 0, 2],
  ['LRD', 'Dollar libérien', 'L$', 0, 2],
  ['LYD', 'Dinar libyen', 'LD', 0, 3],
  ['MGA', 'Ariary malgache', 'Ar', 0, 2],
  ['MWK', 'Kwacha malawien', 'MK', 0, 2],
  ['MUR', 'Roupie mauricienne', 'Rs', 0, 2],
  ['MZN', 'Metical mozambicain', 'MT', 0, 2],
  ['NAD', 'Dollar namibien', 'N$', 0, 2],
  ['STN', 'Dobra santoméen', 'Db', 0, 2],
  ['SCR', 'Roupie seychelloise', 'SR', 0, 2],
  ['SLE', 'Leone sierra-léonais', 'Le', 0, 2],
  ['SOS', 'Shilling somalien', 'Sh', 0, 2],
  ['SDG', 'Livre soudanaise', 'SDG', 0, 2],
  ['SSP', 'Livre sud-soudanaise', 'SSP', 0, 2],
  ['ZMW', 'Kwacha zambien', 'ZK', 0, 2],
  ['ZWG', 'Zig zimbabwéen', 'ZiG', 0, 2],
  ['BRL', 'Real brésilien', 'R$', 0, 2],
  ['INR', 'Roupie indienne', '₹', 0, 2],
  ['QAR', 'Riyal qatari', 'QR', 0, 2],
  ['LBP', 'Livre libanaise', 'LL', 0, 2],
]
